...
@WebServlet("/StudyMaterialsServlet")
public class StudyMaterialsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin/studyMaterials.jsp").forward(request, response);
    }
}
